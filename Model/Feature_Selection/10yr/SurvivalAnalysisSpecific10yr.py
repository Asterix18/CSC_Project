...
data = data.drop(['tnm.m', 'tnm_stage', 'CMS', 'rfs_event_censored_10yr'], axis=1)
...
correlation_matrix = data.drop(['os_months_censored_10yr', 'os_event_censored_10yr'],
                               axis=1).corr()
...
# plt.savefig("../Files/10yr/CorrelationMatrixes/BestFeatures7.png")
# best_features_data.to_csv('../Files/10yr/Best_Features_7.csv', index=False)
