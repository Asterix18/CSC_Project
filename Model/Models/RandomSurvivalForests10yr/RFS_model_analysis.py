...
data = pd.read_csv('../../Files/10yr/FeatureSets/Best_Features_5.csv')
...
time_to_event_data = data[['os_event_censored_5yr', 'os_months_censored_10yr']].to_records(index=False)
